...
export default function History() {
  return (
    <article className='min-h-screen grid place-content-center pt-32' id='history'>
     
     <h2 className={`${satisfy.className} text-center  text-5xl font-semibold text-[#206caf] p-4`}>Historia</h2>
     <div className="flex flex-wrap max-w-[1150px]">
